...
namespace WindowsFormsApp1
{
    public partial class FrmStoklar : Form
    {
        ...
        {
            baglanti.Open();
            SqlCommand komut = new SqlCommand("Insert into AlinanUrunler (Gida,Icecek,Cerezler) values ('"+TxtGidalar.Text+"', '"+Txtİcecekler.Text+"','"+TxtAtistirmaliklar.Text+"')", baglanti);
        ...
        private void button1BtnKaydet2_Click(object sender, EventArgs e)
        {
            baglanti.Open();
