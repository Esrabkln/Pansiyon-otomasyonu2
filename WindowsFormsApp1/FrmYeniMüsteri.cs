...
namespace WindowsFormsApp1
{
    public partial class FrmYeniMüsteri : Form
    {
        ...
        private void BtnOda101_Click(object sender, EventArgs e)
        {
            TxtOdaNo.Text = "101";
            /*baglanti.Open();
            SqlCommand komut = new SqlCommand("Inset ınto Oda101 (Adi,Soyadi) values('" + TxtAdi.Text + "','" + TxtSoyadi.Text + "')", baglanti);
        ...
        private void BtnOda105_Click(object sender, EventArgs e)
        {
            TxtOdaNo.Text = "105";
            /*baglanti.Open();
            SqlCommand komut = new SqlCommand("Inset into Oda105 (Adi,Soyadi) values ('" + TxtAdi.Text + "','" + TxtSoyadi.Text + "')", baglanti);
            komut.ExecuteNonQuery();
            baglanti.Close();*/
        }
